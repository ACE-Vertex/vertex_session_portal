import '../VeraBrowserSession/VeraTaskDispatchBridge'
import type {
...
import '../FirmwareChangeGate/FirmwareChangeGate'
import '../FirmwareChangeGate/FirmwareDecisionBridge'
        ...
        <main class="main">
          ...
          <section class="sessionViewport">
            <div class="sessionTrack">
              ...
              <vertex-firmware-change-gate></vertex-firmware-change-gate>
            </div>
          </section>
        </main>
