...
BASELINE = WORKSTATION / "SESSION_PORTAL_BUILDS" / "000051H1"
BUILDS = WORKSTATION / "SESSION_PORTAL_BUILDS"
STAGING = BUILDS / "000052.staging"
PUBLISHED = BUILDS / "000052"
LAUNCHER = WORKSTATION / "START_SESSION_PORTAL_LATEST.cmd"
POINTER = WORKSTATION / "SESSION_PORTAL_LATEST.pointer.json"
SMOKE = WORKSTATION / "_smoke_session_portal_000052"
...
def publish():
    ...
    launcher_text = (
        "@echo off\r\n"
        "setlocal\r\n"
        f'start "" "%~dp0SESSION_PORTAL_BUILDS\\000052\\{EXE_NAME}"\r\n'
    )
...
def main():
    print("=== VERTEX AUTO TASK SEND COMMIT REPAIR PUBLISH 000052 ===")
