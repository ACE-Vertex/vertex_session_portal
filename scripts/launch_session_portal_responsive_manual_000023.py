...
EVIDENCE = ROOT / "EVIDENCE" / "RESPONSIVE_MANUAL_LAUNCH_000023"
...
def fail(message: str, code: int) -> int:
    ...
    print("VERTEX_SESSION_PORTAL_RESPONSIVE_MANUAL_LAUNCH_000023=FAIL")
    return code

def main() -> int:
    print("VERTEX SESSION PORTAL / RESPONSIVE MANUAL LAUNCH 000023")
    print(f"ROOT={ROOT}")
    ...
    for key in [
        ...
        "VERTEX_RESPONSIVE_SESSION_PROBE",
    ]:
        env.pop(key, None)
    ...
    evidence = {
        "artifact_id": "vertex-session-portal-responsive-manual-launch-000023",
        "timestamp_utc": datetime.now(timezone.utc).isoformat(),
        "mode": "NORMAL_USER_VISIBLE_RESPONSIVE_TEST",
        "pid": proc.pid,
        "project_root": str(ROOT),
        "visual_baseline": "VISUAL_CANONICAL_SF_000020H1",
        "responsive_baseline": "RESPONSIVE_SESSION_SIZING_000022",
        "normal_min_width_px": 600,
        "priority_min_width_px": 1200,
    }
    ...
    print("RESPONSIVE_BASELINE_000022=ACTIVE")
    print("WINDOW_PROCESS_ALIVE_AFTER_2_5S=PASS")
    print(f"LAUNCH_EVIDENCE={evidence_path}")
    print("VERTEX_SESSION_PORTAL_RESPONSIVE_MANUAL_LAUNCH_000023=PASS")
    return 0
