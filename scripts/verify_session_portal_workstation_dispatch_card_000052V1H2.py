...
def owner_scan(token: str) -> list[str]:
    owners: list[str] = []
...
def main() -> int:
    safe_emit("=== VERTEX SESSION PORTAL / WORKSTATION DISPATCH CARD VERIFY 000052V1H2 ===")
    ...
    safe_emit("VERTEX_SESSION_PORTAL_WORKSTATION_DISPATCH_CARD_000052V1H2=PASS")
    return 0
