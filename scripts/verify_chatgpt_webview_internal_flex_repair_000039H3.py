...
def main():
    print('VERTEX SESSION PORTAL / CHATGPT WEBVIEW INTERNAL FLEX REPAIR VERIFY 000039H3')
    print('ROOT='+str(ROOT))
    ...
    checks.append(result('WEBVIEW_FLEX_FILL_PRESERVED', 'flex:1 1 auto' in b.replace(' ','')))
    ...
    checks.append(result('MAIN_HEIGHT_CHAIN_PRESERVED', '.sessionTrack' in maincss and 'height:100%' in maincss.replace(' ','')))
    ...
    if not all(checks):
        print('VERTEX_SESSION_PORTAL_CHATGPT_WEBVIEW_INTERNAL_FLEX_REPAIR_000039H3=FAIL')
        raise SystemExit(1)
    ...
    print('BUILD=PASS')
    print('VERTEX_SESSION_PORTAL_CHATGPT_WEBVIEW_INTERNAL_FLEX_REPAIR_000039H3=PASS')
