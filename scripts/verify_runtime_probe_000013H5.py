...
def main() -> int:
    print("VERTEX SESSION PORTAL / RUNTIME PROBE VERIFY 000013H5")
    print(f"ROOT={ROOT}")
    print("REPAIR=VIZ_CAPTURE_FRAME_PRESENTATION_AND_RETRY")
    ...
    if build.returncode != 0:
        print("BUILD=FAIL")
        print("VERTEX_SESSION_PORTAL_RUNTIME_VERIFY_000013H5=FAIL")
        return 2
    ...
    print("RUNTIME=PASS")
    print("VERTEX_SESSION_PORTAL_RUNTIME_VERIFY_000013H5=PASS")
    return 0
